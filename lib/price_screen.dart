...
class _PriceScreenState extends State<PriceScreen> {
  ...
  DropdownButton getDropDownItems() {
    ...
    for (final currency in currenciesList) {
      dropDownMenuItems.add(DropdownMenuItem(child: Text(currency)));
    }
    return DropdownButton(items: dropDownMenuItems, onChanged: (value) {
      ...
      body: Column(
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: Platform.isIOS ? getPicker() : getDropDownItems(),
          ),
        ],
      ),
    );
